...
const Navber = () => {
    ...
    const navItem =
        <>
            ...
            <div className='lg:flex ml-96 m-0'>
    ...
    return (
        <div className="navbar sm:bg-slate-600 text-black z-10 w-full lg:px-6">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu -mr-30  menu-sm dropdown-content mt-1 shadow flex-none">
                        {navItem}
                    </ul>
                </div>
